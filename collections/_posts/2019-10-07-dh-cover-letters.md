...
- Digital Humanities
---
Early this summer, we (authors Brandon and Amanda!) planned a post about job search materials, but finishing up the draft got delayed by several weeks. In the intervening time, a minor Twitter kerfluffle emerged on the subject, and we ended up holding off this post for a few months while discussing how to do it well. 

The kerfuffle in question - someone shared the job advice they generally give students on the academic job market, and folks responded with frustrations about the prescriptiveness, privilege, and point of this advice genre. Since then, we've also noticed [inspiring work being done on the topic by Hannah Alpert-Abrams](https://twitter.com/hralperta/status/1143557245168476160?s=21). The Academic Job Market Support Network that she has spearheaded shares a lot of the spirit behind what we intended to do with our job search materials, so we're taking this as an opportunity to revisit the post we had planned. We have both uploaded cover letters to the AJMSN (Brandon's letter [here](https://hcommons.org/?get_group_doc=1003473/1570202258-HeadofGraduateProgramsCoverLetter.docx) and Amanda's letter [here](https://hcommons.org/?get_group_doc=1003473/1570038081-CoverLetter.pdf)), and we talk a bit about our reasoning below. We'll offer some general thoughts about job searches in digital humanities and annotate each other's letters. 

## Worse job advice, better job advice

Framing an academic job search exclusively in terms of handy tips undervalues the degree of luck that goes into any search. _Do these things_, such advice seems to suggest, _and the just and right meritocracy will reward you with a job_. But the academic job market is anything but just, and anything but a pure measure of merit. The same is true, of course, for job markets beyond academia. Digital humanities job searches, be they for faculty positions or otherwise, suffer from the same issues.

Advice on any job market should come with a frank discussion about about all the factors involved in being offered a job (i.e. how many factors are out of candidates' hands), and about job precarity. A few thoughts

1. The academic job market is not identical with all job markets in academia. There are a range of different careers that engage in intellectual work, careers that might be called alt-ac (though there are good reasons for not using that term to describe them). Paths to these careers are often just as obscured as paths to professorships, and resources for how to navigate these types of job searches are scarce.

2. Students need our support. In particular, refusing to share resources reinforces privileged access to those same materials. Our initial reason for writing this post was that we noticed we were repeatedly sharing the same cover letters with people. We found ourselves wondering in conversation how many other people at UVA or elsewhere might not know to ask for such resources. 

3. Offers to aid in job searches, on and off the tenure track, should be made but they should also go beyond lists of advice. In particular, we try to emphasize backup plans and talking with a career center as part of the conversation about how to seek positions in digital humanities. 

4. Student support necessarily includes emotional labor. For us, at least, this is a requirement. We try to emphasize that the student is smart enough and good enough for this work, that the job market is not a reflection on them, and that our current jobs are are the results of luck in a lottery system (and every time you win a lottery it makes future lotteries easier…). It is not enough to tell students that they need do X and Y in order to be successful. In the Lab we believe these conversations need to engage with the messy work of what the job search entails. 

We're not sure how we share our cover letters given this context, but it still seems worth doing; we're going to continue advising the local students who work with us, and we'd like to help students who are elsewhere if we can. Some of the ways we try to model good advising include:

* Not posting job ads to the SLab Slack fellows channels (where they might be reminders of job market stress to folks who aren't even looking for work right now, or otherwise want to limit when they're thinking about jobs). We've moved to including a list of interesting jobs to the end of our lab newsletter instead.  
...
* Focus our commentary not on "what others will expect" or "the right way to do things" (e.g. how to write the salutation), but instead showing examples of how to best communicate one’s personal strengths via cover letter
* Leaven advice with affirmation of students as scholars and humans; help them think about how to do what they value in life, even if they can’t do that as their main job  
* Share cover letters rather than CVs—making it easier to extrapolate to how any person presents their strengths, vs. CVs discouraging folks with different skillsets/experiences

## Thoughts on some specific DH cover letters

Below, each of us share the text of one of our cover letter for the other to annotate. The comments below reflect what we’ve tried to do when we have served on hiring committees and reviewing cover letters: the kind of stuff we feel we _shouldn’t_ evaluate on, and what we do look for. Of course, these should be taken with a grain of salt. Other people serving on DH hiring committees might look for different things. We'll focus on the hiring experience for:
* Brandon's current role: Head of Student Programs at the University of Virginia Library's Scholars' Lab[^1]
* Amanda's previous role: tenure-track assistant professor and DH specialist at Purdue University Libraries[^2]
...
* He again recognizes specifics about the lab—that through our staff charter, choices, etc. we try to be attentive to how our values shape our work. 
```
...
```
* It's good to share things you're proud of! If you don't highlight these, your search committee might never know about them. 
...
```
* To underscore what Amanda says above - I usually tell people to make sure their letter is not an extension of their CV. When addressing things that appear in both, I usually try to make sure the things in the letter expand or provide context that you might not otherwise get in a CV. This is great, because she expands on a project that might otherwise only get a line and not have the same impact. 
...
* Amanda's accomplishments here and as articulated in the letter are impressive, but I often think it's a matter of selling yourself regardless of whether or not you have thousands of hits. Take the things you have done and use them as an opportunity to spin a story about yourself. 
...
## Endnotes
[^1] Brandon's title has been expanded over the course of his work here; at the time of hiring, it was "Head of Graduate Programs".
[^2] We thought this be more broadly useful to students than the cover letter for her current job, as that fits leaving a faculty role to direct a lab, rather than locating one's first post-PhD job.
