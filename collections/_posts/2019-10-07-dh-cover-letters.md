...
Below, each of us share the text of one of our cover letter for the other to annotate. The comments below reflect what we’ve tried to do when we have served on hiring committees and reviewing cover letters: avoid the stuff we feel we _shouldn’t_ evaluate on, and what we _do_ look for. Of course, these should be taken with a grain of salt. Other people serving on DH hiring committees might look for different things. We'll focus on the hiring experience for:  
...
## Endnotes
[^0] The coiner of the word "meritocracy" intended it to ridicule the very ideas folks now use the term to convey.  
