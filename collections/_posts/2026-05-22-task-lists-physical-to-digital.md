...
![task list in slack as conveyed through a series of reminders.](/assets/post-media/task-lists-physical-to-digital/1.png)
...
![task list in a notebook with separate sections for "can do," "must do," and "waiting."](/assets/post-media/task-lists-physical-to-digital/2.png)
