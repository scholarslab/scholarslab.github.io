...
<picture style="display:block; margin:auto; width:96%; margin-top:5em; margin-bottom:5em;">
    <img src="/assets/post-media/2026-05-21-mini-tutorial-11ty.png" style="width:100%; height:auto; box-shadow: 0.5rem 0.5rem 0 var(--blue-alt);" alt="A two-axis coordinate plane representing the intersection of breadth and depth in DH.">
    <figcaption><i><strong>Figure 1. Screenshot of the Mini-Tutorial section on 11ty's documentation page.</strong></i></figcaption>
</picture>
...
<picture style="display:block; width:90%; margin-top:5em; margin-bottom:5em;">
    <img src="/assets/post-media/2026-05-21-deploy-yaml.jpg" style="width:100%; height:auto; box-shadow: 0.5rem 0.5rem 0 var(--blue-alt);" alt="A two-axis coordinate plane representing the intersection of breadth and depth in DH.">
