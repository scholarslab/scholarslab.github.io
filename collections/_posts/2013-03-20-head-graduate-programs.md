...
We are delighted to announce an exciting job opportunity here at the [Scholars’ Lab](https://scholarslab.org/) as the Head of Graduate Programs, which includes both the [Praxis Program](https://praxis.scholarslab.org/) and the [Graduate Fellows in Digital Humanities](https://scholarslab.org/graduate-fellowships/) program. Read on for more details!
