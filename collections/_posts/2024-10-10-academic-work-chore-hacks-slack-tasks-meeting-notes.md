...
crosspost:
  - title: Amanda's blog
    url: 
---
_(Part 2 of a 3-part series: see also [the 1st post on email practices and some caveats about my particular context]() and [the 3rd post on supporting work practices like these, as a manager](), once they're published. This note will be updated once those links should be working!)_

More notes on what works for me, when managing alt-academic job work-chores (see my [first post]() in the series for caveats about context).
